...
public interface FormulaGrammarListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by the {@code PuAnnouncement}
	 * labeled alternative in {@link FormulaGrammarParser#formula}.
	 * @param ctx the parse tree
	 */
	void enterPuAnnouncement(FormulaGrammarParser.PuAnnouncementContext ctx);
	/**
	 * Exit a parse tree produced by the {@code PuAnnouncement}
	 * labeled alternative in {@link FormulaGrammarParser#formula}.
	 * @param ctx the parse tree
	 */
	void exitPuAnnouncement(FormulaGrammarParser.PuAnnouncementContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by the {@code GrAnnouncement}
	 * labeled alternative in {@link FormulaGrammarParser#formula}.
	 * @param ctx the parse tree
	 */
	void enterGrAnnouncement(FormulaGrammarParser.GrAnnouncementContext ctx);
	/**
	 * Exit a parse tree produced by the {@code GrAnnouncement}
	 * labeled alternative in {@link FormulaGrammarParser#formula}.
	 * @param ctx the parse tree
	 */
	void exitGrAnnouncement(FormulaGrammarParser.GrAnnouncementContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link FormulaGrammarParser#palformula}.
	 * @param ctx the parse tree
	 */
	void enterPalformula(FormulaGrammarParser.PalformulaContext ctx);
	/**
	 * Exit a parse tree produced by {@link FormulaGrammarParser#palformula}.
	 * @param ctx the parse tree
	 */
	void exitPalformula(FormulaGrammarParser.PalformulaContext ctx);
	/**
