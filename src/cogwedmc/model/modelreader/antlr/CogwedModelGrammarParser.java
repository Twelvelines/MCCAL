...
public class CogwedModelGrammarParser extends Parser {
    ...
    public static final int
            RULE_cogwed_model_file = 0, RULE_nofagents = 1, RULE_statesdef = 2,
            RULE_reldef = 3, RULE_edge = 4, RULE_atomsdef = 5,
            RULE_singledef = 6, RULE_gstateslist = 7;
    public static final String[] ruleNames = {
            "cogwed_model_file", "nofagents", "statesdef",
            "reldef", "edge", "atomsdef",
    ...
    public static class Cogwed_model_fileContext extends ParserRuleContext {
        ...
        public ReldefContext tempreldef() {
        ...
        public int getRuleIndex() {
            return RULE_cogwed_model_file;
        }

        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof CogwedModelGrammarListener)
                ((CogwedModelGrammarListener) listener).enterCogwed_model_file(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof CogwedModelGrammarListener)
                ((CogwedModelGrammarListener) listener).exitCogwed_model_file(this);
        }
    }
    ...
    public static class NofagentsContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_nofagents;
        }

        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof CogwedModelGrammarListener)
                ((CogwedModelGrammarListener) listener).enterNofagents(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof CogwedModelGrammarListener)
                ((CogwedModelGrammarListener) listener).exitNofagents(this);
        }
    }
    ...
    public static class StatesdefContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_statesdef;
        }

        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof CogwedModelGrammarListener)
                ((CogwedModelGrammarListener) listener).enterStatesdef(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof CogwedModelGrammarListener)
                ((CogwedModelGrammarListener) listener).exitStatesdef(this);
        }
    }
...
/*
    public static class StatedefContext extends ParserRuleContext {
        public TerminalNode ID() {
            return getToken(CogwedModelGrammarParser.ID, 0);
        }
        ...
        @Override
        public int getRuleIndex() {
            return RULE_statedef;
        }

        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof CogwedModelGrammarListener)
                ((CogwedModelGrammarListener) listener).enterStatedef(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof CogwedModelGrammarListener)
                ((CogwedModelGrammarListener) listener).exitStatedef(this);
        }
    }
    ...
    public static class LstateslistContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_lstateslist;
        }

        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof CogwedModelGrammarListener)
                ((CogwedModelGrammarListener) listener).enterLstateslist(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof CogwedModelGrammarListener)
                ((CogwedModelGrammarListener) listener).exitLstateslist(this);
        }
    }
    ...
    */
    ...
    public static class ReldefContext extends ParserRuleContext {
        public List<EdgeContext> pairofstates() {
            return getRuleContexts(EdgeContext.class);
        }

        public EdgeContext pairofstates(int i) {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof CogwedModelGrammarListener)
                ((CogwedModelGrammarListener) listener).enterReldef(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof CogwedModelGrammarListener)
                ((CogwedModelGrammarListener) listener).exitReldef(this);
        }
    }
    ...
    public final ReldefContext reldef() throws RecognitionException {
        ...
        enterRule(_localctx, 10, RULE_reldef);
        int _la;
        try {
            enterOuterAlt(_localctx, 1);
            {
    ...
    public static class EdgeContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof CogwedModelGrammarListener)
                ((CogwedModelGrammarListener) listener).enterEdge(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof CogwedModelGrammarListener)
                ((CogwedModelGrammarListener) listener).exitEdge(this);
        }
    }
    ...
    public static class AtomsdefContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_atomsdef;
        }

        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof CogwedModelGrammarListener)
                ((CogwedModelGrammarListener) listener).enterAtomsdef(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof CogwedModelGrammarListener)
                ((CogwedModelGrammarListener) listener).exitAtomsdef(this);
        }
    }
    ...
    public static class SingledefContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_singledef;
        }

        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof CogwedModelGrammarListener)
                ((CogwedModelGrammarListener) listener).enterSingledef(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof CogwedModelGrammarListener)
                ((CogwedModelGrammarListener) listener).exitSingledef(this);
        }
    }
    ...
    public static class GstateslistContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_gstateslist;
        }

        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof CogwedModelGrammarListener)
                ((CogwedModelGrammarListener) listener).enterGstateslist(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof CogwedModelGrammarListener)
                ((CogwedModelGrammarListener) listener).exitGstateslist(this);
        }
    }
